            ...
            <section className={styles.section_container}>
                <form className={styles.form_container} onSubmit={submitData}>
                    ...
                    <div className={styles.form}>
                        <label className={styles.subtitle}><h3>Nombre de la noticia</h3></label>
                    ...
                    <div className={styles.form}>
                        <label className={styles.subtitle}><h3>Contenido escrito de la misma</h3></label>
                        <textarea
                    ...
                    <div className={styles.form}>
                        <label className={styles.subtitle}><h3>Tecnologías</h3></label>
                        <input
                            className={styles.nom_input}
                            type="text"
                            name="tecno"
                    ...
                    <div className={styles.form}>
                        <label className={styles.subtitle}><h3>Imagen</h3></label>
