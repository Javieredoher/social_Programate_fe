    ...
    <>
      ...
      <Routes>
        ...
        */}
        ...
        {/* Admin
        validate => admin */}
        <Route exact path="/adminhome" element={isLogged ? <AdminHomePage/>: <NotFound />} /> 
        ...
        {/* Profile */}
        <Route exact path="/formprofile" element={isLogged ? <CompletePerfil /> : <NotFound />} />
        <Route exact path="/formprofile/:id" element={isLogged ? <EditProfile /> : <NotFound />} />  
        ...
        <Route exact path="/formeventedit/:id" element={isLogged ? <FormEventEdit /> : <NotFound />} />

        <Route exact path="/formnews" element={isLogged ? <FormNewsPage/> : <NotFound />} />
        <Route exact path="/formnews/:id" element={isLogged ? <FormNewsPage/> : <NotFound />} />

        <Route exact path="/formjobs" element={isLogged ? <FormJobsPage/> : <NotFound />} />
        <Route exact path="/formjobs/:id" element={isLogged ? <FormJobsPage/> : <NotFound />} />
